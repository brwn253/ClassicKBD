...
public class Present implements UsePlayerTrigger, OpInvTrigger {
	...
	static {
		...
		ultraRareTable.addItemDrop(ItemId.DRAGON_LONG_SWORD.id(), 1, 14, false);
		ultraRareTable.addItemDrop(ItemId.DRAGON_BATTLE_AXE.id(), 1, 10, false);
		ultraRareTable.addItemDrop(ItemId.MEDIUM_DRAGON_HELMET.id(), 1, 2, false);
