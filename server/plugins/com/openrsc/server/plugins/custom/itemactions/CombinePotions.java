...
public class CombinePotions implements UseInvTrigger {
	...
	int[][] combinePotions = {
		...
		{ItemId.ONE_WOODWORKING_POTION.id(), ItemId.TWO_WOODWORKING_POTION.id(), ItemId.FULL_WOODWORKING_POTION.id()},
		{ItemId.ONE_SUPER_PRAYER_POTION.id(), ItemId.TWO_SUPER_PRAYER_POTION.id(), ItemId.FULL_SUPER_PRAYER_POTION.id()},
		{ItemId.ONE_ULTIMATE_ATTACK_POTION.id(), ItemId.TWO_ULTIMATE_ATTACK_POTION.id(), ItemId.FULL_ULTIMATE_ATTACK_POTION.id()},
		{ItemId.ONE_ULTIMATE_STRENGTH_POTION.id(), ItemId.TWO_ULTIMATE_STRENGTH_POTION.id(), ItemId.FULL_ULTIMATE_STRENGTH_POTION.id()},
		{ItemId.ONE_ULTIMATE_DEFENSE_POTION.id(), ItemId.TWO_ULTIMATE_DEFENSE_POTION.id(), ItemId.FULL_ULTIMATE_DEFENSE_POTION.id()},
		{ItemId.ONE_ULTIMATE_ZAMORAK_POTION.id(), ItemId.TWO_ULTIMATE_ZAMORAK_POTION.id(), ItemId.FULL_ULTIMATE_ZAMORAK_POTION.id()},
	};
