...
public class WitchesHouse implements QuestInterface, TalkNpcTrigger,
	...
	public static final int[] METAL_ARMOURS = {
		//plate bodies
		ItemId.BRONZE_PLATE_MAIL_BODY.id(), ItemId.IRON_PLATE_MAIL_BODY.id(), ItemId.STEEL_PLATE_MAIL_BODY.id(), ItemId.MITHRIL_PLATE_MAIL_BODY.id(), ItemId.ADAMANTITE_PLATE_MAIL_BODY.id(), ItemId.BLACK_PLATE_MAIL_BODY.id(), ItemId.RUNE_PLATE_MAIL_BODY.id(), ItemId.DRAGON_PLATE_MAIL_BODY.id(), ItemId.KHORIUM_PLATE_MAIL_BODY.id(), ItemId.PLATINUM_PLATE_MAIL_BODY.id(), ItemId.TITANIUM_PLATE_MAIL_BODY.id(),
		//plate tops
		ItemId.BRONZE_PLATE_MAIL_TOP.id(), ItemId.IRON_PLATE_MAIL_TOP.id(), ItemId.STEEL_PLATE_MAIL_TOP.id(), ItemId.MITHRIL_PLATE_MAIL_TOP.id(), ItemId.ADAMANTITE_PLATE_MAIL_TOP.id(), ItemId.BLACK_PLATE_MAIL_TOP.id(), ItemId.RUNE_PLATE_MAIL_TOP.id(), ItemId.DRAGON_PLATE_MAIL_TOP.id(), ItemId.KHORIUM_PLATE_MAIL_TOP.id(), ItemId.PLATINUM_PLATE_MAIL_TOP.id(), ItemId.TITANIUM_PLATE_MAIL_TOP.id(),
		//chain bodies
		ItemId.BRONZE_CHAIN_MAIL_BODY.id(), ItemId.IRON_CHAIN_MAIL_BODY.id(), ItemId.STEEL_CHAIN_MAIL_BODY.id(), ItemId.MITHRIL_CHAIN_MAIL_BODY.id(), ItemId.ADAMANTITE_CHAIN_MAIL_BODY.id(), ItemId.BLACK_CHAIN_MAIL_BODY.id(), ItemId.RUNE_CHAIN_MAIL_BODY.id(), ItemId.DRAGON_SCALE_MAIL.id(), ItemId.DRAGON_CHAIN_MAIL_BODY.id(), ItemId.KHORIUM_CHAIN_MAIL_BODY.id(), ItemId.PLATINUM_CHAIN_MAIL_BODY.id(), ItemId.TITANIUM_CHAIN_MAIL_BODY.id(),
		//chain legs
		ItemId.BRONZE_CHAIN_MAIL_LEGS.id(), ItemId.IRON_CHAIN_MAIL_LEGS.id(), ItemId.STEEL_CHAIN_MAIL_LEGS.id(), ItemId.MITHRIL_CHAIN_MAIL_LEGS.id(), ItemId.ADAMANTITE_CHAIN_MAIL_LEGS.id(), ItemId.BLACK_CHAIN_MAIL_LEGS.id(), ItemId.RUNE_CHAIN_MAIL_LEGS.id(), ItemId.DRAGON_CHAIN_MAIL_LEGS.id(), ItemId.KHORIUM_CHAIN_MAIL_LEGS.id(), ItemId.PLATINUM_CHAIN_MAIL_LEGS.id(), ItemId.TITANIUM_CHAIN_MAIL_LEGS.id(),
		//plate legs
		ItemId.BRONZE_PLATE_MAIL_LEGS.id(), ItemId.IRON_PLATE_MAIL_LEGS.id(), ItemId.STEEL_PLATE_MAIL_LEGS.id(), ItemId.MITHRIL_PLATE_MAIL_LEGS.id(), ItemId.ADAMANTITE_PLATE_MAIL_LEGS.id(), ItemId.BLACK_PLATE_MAIL_LEGS.id(), ItemId.RUNE_PLATE_MAIL_LEGS.id(), ItemId.DRAGON_PLATE_MAIL_LEGS.id(), ItemId.KHORIUM_PLATE_MAIL_LEGS.id(), ItemId.PLATINUM_PLATE_MAIL_LEGS.id(), ItemId.TITANIUM_PLATE_MAIL_LEGS.id(),
		//plate skirts
		ItemId.BRONZE_PLATED_SKIRT.id(), ItemId.IRON_PLATED_SKIRT.id(), ItemId.STEEL_PLATED_SKIRT.id(), ItemId.MITHRIL_PLATED_SKIRT.id(), ItemId.ADAMANTITE_PLATED_SKIRT.id(), ItemId.BLACK_PLATED_SKIRT.id(), ItemId.RUNE_SKIRT.id(), ItemId.DRAGON_PLATED_SKIRT.id(), ItemId.KHORIUM_PLATED_SKIRT.id(), ItemId.PLATINUM_PLATED_SKIRT.id(), ItemId.TITANIUM_PLATED_SKIRT.id(),
		//medium helmets
		ItemId.MEDIUM_BRONZE_HELMET.id(), ItemId.MEDIUM_IRON_HELMET.id(), ItemId.MEDIUM_STEEL_HELMET.id(), ItemId.MEDIUM_MITHRIL_HELMET.id(), ItemId.MEDIUM_ADAMANTITE_HELMET.id(), ItemId.MEDIUM_BLACK_HELMET.id(), ItemId.MEDIUM_RUNE_HELMET.id(), ItemId.MEDIUM_DRAGON_HELMET.id(), ItemId.MEDIUM_DRAGON_HELMET.id(), ItemId.MEDIUM_KHORIUM_HELMET.id(), ItemId.MEDIUM_PLATINUM_HELMET.id(), ItemId.MEDIUM_TITANIUM_HELMET.id(),
		//large helmets
		ItemId.LARGE_BRONZE_HELMET.id(), ItemId.LARGE_IRON_HELMET.id(), ItemId.LARGE_STEEL_HELMET.id(), ItemId.LARGE_MITHRIL_HELMET.id(), ItemId.LARGE_ADAMANTITE_HELMET.id(), ItemId.LARGE_BLACK_HELMET.id(), ItemId.LARGE_RUNE_HELMET.id(), ItemId.LARGE_DRAGON_HELMET.id(), ItemId.LARGE_KHORIUM_HELMET.id(), ItemId.LARGE_PLATINUM_HELMET.id(), ItemId.LARGE_TITANIUM_HELMET.id(),
		//square shields
		ItemId.BRONZE_SQUARE_SHIELD.id(), ItemId.IRON_SQUARE_SHIELD.id(), ItemId.STEEL_SQUARE_SHIELD.id(), ItemId.MITHRIL_SQUARE_SHIELD.id(), ItemId.ADAMANTITE_SQUARE_SHIELD.id(), ItemId.BLACK_SQUARE_SHIELD.id(), ItemId.RUNE_SQUARE_SHIELD.id(), ItemId.DRAGON_SQUARE_SHIELD.id(), ItemId.KHORIUM_SQUARE_SHIELD.id(), ItemId.PLATINUM_SQUARE_SHIELD.id(), ItemId.TITANIUM_SQUARE_SHIELD.id(),
		//kite shields
		ItemId.BRONZE_KITE_SHIELD.id(), ItemId.IRON_KITE_SHIELD.id(), ItemId.STEEL_KITE_SHIELD.id(), ItemId.MITHRIL_KITE_SHIELD.id(), ItemId.ADAMANTITE_KITE_SHIELD.id(), ItemId.BLACK_KITE_SHIELD.id(), ItemId.RUNE_KITE_SHIELD.id(), ItemId.DRAGON_KITE_SHIELD.id(), ItemId.KHORIUM_KITE_SHIELD.id(), ItemId.PLATINUM_KITE_SHIELD.id(), ItemId.TITANIUM_KITE_SHIELD.id()
	};
