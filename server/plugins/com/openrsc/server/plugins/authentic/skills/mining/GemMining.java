...
public class GemMining implements OpLocTrigger, UseLocTrigger {
	...
	private static final int[] gemWeightsWithoutDragonstone = {64, 32, 16, 8, 3, 3, 2, 1};
	private static final int[] gemWeightsWithDragonstone = {60, 30, 15, 9, 5, 5, 4, 2};
	...
	private String minedString(int gemID) {
		...
		} else if (gemID == ItemId.UNCUT_ONYX.id()) {
			return "You just found a onyx!";
		} 
		return null;
	}
