	...
	private void useWool(Player player, final Item woolBall, final Item item) {
		...
		switch (ItemId.getById(item.getCatalogId())) {
			...
			case UNSTRUNG_DRAGONSTONE_AMULET:
				...
				break;
			case UNSTRUNG_OPAL_AMULET:
				newID = ItemId.OPAL_AMULET.id();
				break;
			case UNSTRUNG_TOPAZ_AMULET:
				newID = ItemId.OPAL_AMULET.id();
				break;
			case UNSTRUNG_JADE_AMULET:
				newID = ItemId.JADE_AMULET.id();
				break;
			case UNSTRUNG_ONYX_AMULET:
				newID = ItemId.ONYX_AMULET.id();
				break;			
			default:
				return;
		}
