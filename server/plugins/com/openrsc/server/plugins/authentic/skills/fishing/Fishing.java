			...
			if (fishLst.size() == 0) {
				...
				switch (ItemId.getById(fish.getCatalogId())) {
					...
					case RAW_ANCHOVIES:
						...
						break;
					case RAW_PIRAHNAS:
						player.playerServerMessage(MessageType.QUEST, "You catch some pirahnas!");
						break;
					case RAW_ANGELFISH:
						player.playerServerMessage(MessageType.QUEST, "You catch a angelfish!");
						break;
					case RAW_PUFFERFISH:
						player.playerServerMessage(MessageType.QUEST, "You catch a pufferfish!");
						break;
					case RAW_DRAGONSHARK:
						player.playerServerMessage(MessageType.QUEST, "You catch a dragonshark!");
						break;
					default:
