...
public class Fletching implements UseInvTrigger {
	...
	private static final int[] attachmentIds = {
		...
		ItemId.DRAGON_DART_TIPS.id(),
		ItemId.KHORIUM_DART_TIPS.id(),
		ItemId.PLATINUM_DART_TIPS.id(),
		ItemId.TITANIUM_DART_TIPS.id()
	...
	private static final int[] unstrungBows = {
		...
		ItemId.UNSTRUNG_MYSTIC_SHORTBOW.id(),
		ItemId.UNSTRUNG_MYSTIC_LONGBOW.id(),
		ItemId.UNSTRUNG_CORK_SHORTBOW.id(),
		ItemId.UNSTRUNG_CORK_LONGBOW.id(),
		ItemId.UNSTRUNG_BOOJUM_SHORTBOW.id(),
		ItemId.UNSTRUNG_BOOJUM_LONGBOW.id(),
		ItemId.UNSTRUNG_GUM_SHORTBOW.id(),
		ItemId.UNSTRUNG_GUM_LONGBOW.id(),
		ItemId.UNSTRUNG_TWISTED_SHORTBOW.id(),
		ItemId.UNSTRUNG_TWISTED_LONGBOW.id()
	...
	private static final int[] arrowHeads = {
		...
		ItemId.DRAGON_ARROW_HEADS.id(),
		ItemId.KHORIUM_ARROW_HEADS.id(),
		ItemId.PLATINUM_ARROW_HEADS.id(),
		ItemId.TITANIUM_ARROW_HEADS.id()
	...
	private static final int[] logIds = {
		...
		ItemId.MYSTIC_LOGS.id(),
		ItemId.CORK_LOGS.id(),
		ItemId.BOOJUM_LOGS.id(),
		ItemId.GUM_LOGS.id(),
		ItemId.TWISTED_LOGS.id()
