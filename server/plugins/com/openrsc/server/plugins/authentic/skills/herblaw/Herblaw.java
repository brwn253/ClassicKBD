...
public class Herblaw implements OpInvTrigger, UseInvTrigger {
	...
	private static int[] unidentifiedHerbs = {
		...
		ItemId.UNIDENTIFIED_SPICE.id(),
		ItemId.UNIDENTIFIED_TEA_LEAF.id(),
		ItemId.UNIDENTIFIED_DEATH_ROSE.id(),		
		ItemId.UNIDENTIFIED_FOOLS_WEED.id(),
		ItemId.UNIDENTIFIED_GOD_LILY.id(),
		ItemId.UNIDENTIFIED_RUNE_POPPY.id(),
		ItemId.UNIDENTIFIED_DRAGON_LOTUS.id()	
