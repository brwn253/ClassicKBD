...
public final class Development implements CommandTrigger {
	...
	private void fishingRate(Player player, String command, String[] args) {
		...
		fishingDefs.put("mantaray", player.getWorld().getServer().getEntityHandler().getObjectFishingDef(1323, 1));
		fishingDefs.put("seaturtle", player.getWorld().getServer().getEntityHandler().getObjectFishingDef(1324, 1));
		fishingDefs.put("lavaeel2", player.getWorld().getServer().getEntityHandler().getObjectFishingDef(1325, 1));
		fishingDefs.put("pirahnas", player.getWorld().getServer().getEntityHandler().getObjectFishingDef(1326, 1));
		fishingDefs.put("angelfish", player.getWorld().getServer().getEntityHandler().getObjectFishingDef(1327, 1));
		fishingDefs.put("pufferfish", player.getWorld().getServer().getEntityHandler().getObjectFishingDef(1328, 1));
		fishingDefs.put("dragonshark", player.getWorld().getServer().getEntityHandler().getObjectFishingDef(1329, 1));
		fishingDefs.put("shark2", player.getWorld().getServer().getEntityHandler().getObjectFishingDef(1330, 1));
	...
	private void logRate(Player player, String[] args) {
		...
		} else if (axe.equalsIgnoreCase("khorium")) {
			axeId = ItemId.KHORIUM_AXE.id();
		} else if (axe.equalsIgnoreCase("platinum")) {
			axeId = ItemId.PLATINUM_AXE.id();
		} else if (axe.equalsIgnoreCase("titanium")) {
			axeId = ItemId.TITANIUM_AXE.id();
		}
