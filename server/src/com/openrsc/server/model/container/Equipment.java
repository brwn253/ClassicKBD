...
public class Equipment {
	...
	public boolean ableToEquip(Item item) {
		...
		// Dragon sword
		else if (item.getCatalogId() == ItemId.DRAGON_LONG_SWORD.id() && player.getQuestStage(Quests.LOST_CITY) != -1) {
			player.message("you have not earned the right to wear this yet");
		...
		// Dragon battle axe
		else if (item.getCatalogId() == ItemId.DRAGON_BATTLE_AXE.id() && player.getQuestStage(Quests.HEROS_QUEST) != -1) {
			player.message("you have not earned the right to wear this yet");
