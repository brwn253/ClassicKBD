...
public class CombatFormula {
	...
	private static int rangedPower(final int arrowId) {
		...
		switch (ItemId.getById(arrowId)) {
			...
			case POISON_DRAGON_BOLTS:
				return 69;
			case DRAGON_THROWING_DART:
			case POISONED_DRAGON_THROWING_DART:
				return 77;
			case KHORIUM_THROWING_DART:
			case POISONED_KHORIUM_THROWING_DART:
				return 80;
			case PLATINUM_THROWING_DART:
			case POISONED_PLATINUM_THROWING_DART:
				return 82;
			case TITANIUM_THROWING_DART:
			case POISONED_TITANIUM_THROWING_DART:
				return 84;
			case KHORIUM_ARROWS:
			case POISON_KHORIUM_ARROWS:
			case DRAGON_THROWING_KNIFE:
			case POISONED_DRAGON_THROWING_KNIFE:
				return 86;
			case PLATINUM_ARROWS:
			case POISON_PLATINUM_ARROWS:
			case KHORIUM_THROWING_KNIFE:
			case POISONED_KHORIUM_THROWING_KNIFE:
				return 88;
			case TITANIUM_ARROWS:
			case POISON_TITANIUM_ARROWS:
			case PLATINUM_THROWING_KNIFE:
			case POISONED_PLATINUM_THROWING_KNIFE:
				return 90;
			case TITANIUM_THROWING_KNIFE:
			case POISONED_TITANIUM_THROWING_KNIFE:
			case DRAGON_SPEAR:
			case POISONED_DRAGON_SPEAR:
				return 92;
			case KHORIUM_SPEAR:
			case POISONED_KHORIUM_SPEAR:
				return 94;
			case PLATINUM_SPEAR:
			case POISONED_PLATINUM_SPEAR:
				return 96;
			case TITANIUM_SPEAR:
			case POISONED_TITANIUM_SPEAR:
				return 98;
			default:
				return 0;
		}
	...
	private static int rangedAim(final int bowId) {
		...
		switch (ItemId.getById(bowId)) {
			...
			case PLATINUM_SPEAR:
			case POISONED_PLATINUM_SPEAR:
			case TWISTED_LONGBOW:
			case TWISTED_SHORTBOW:
				return 80;
			case TITANIUM_SPEAR:
			case POISONED_TITANIUM_SPEAR:
				return 81;
