...
public class NpcDrops {
	...
	private void createHerbDropTable() {
		...
		herbDropTable.addItemDrop(ItemId.UNIDENTIFIED_GUAM_LEAF.id(), 1, 19);
		herbDropTable.addItemDrop(ItemId.UNIDENTIFIED_MARRENTILL.id(), 1, 16);
		herbDropTable.addItemDrop(ItemId.UNIDENTIFIED_TARROMIN.id(), 1, 15);
		herbDropTable.addItemDrop(ItemId.UNIDENTIFIED_HARRALANDER.id(), 1, 14);
		herbDropTable.addItemDrop(ItemId.UNIDENTIFIED_RANARR_WEED.id(), 1, 13);
		herbDropTable.addItemDrop(ItemId.UNIDENTIFIED_IRIT_LEAF.id(), 1, 7);
		herbDropTable.addItemDrop(ItemId.UNIDENTIFIED_AVANTOE.id(), 1, 7);
		herbDropTable.addItemDrop(ItemId.UNIDENTIFIED_KWUARM.id(), 1, 7);
		herbDropTable.addItemDrop(ItemId.UNIDENTIFIED_CADANTINE.id(), 1, 7);
		herbDropTable.addItemDrop(ItemId.UNIDENTIFIED_DWARF_WEED.id(), 1, 5);
		herbDropTable.addItemDrop(ItemId.UNIDENTIFIED_SPICE.id(), 1, 4);
		herbDropTable.addItemDrop(ItemId.UNIDENTIFIED_TEA_LEAF.id(), 1, 4);
		herbDropTable.addItemDrop(ItemId.UNIDENTIFIED_DEATH_ROSE.id(), 1, 3);
		herbDropTable.addItemDrop(ItemId.UNIDENTIFIED_FOOLS_WEED.id(), 1, 2);
		herbDropTable.addItemDrop(ItemId.UNIDENTIFIED_GOD_LILY.id(), 1, 2);
		herbDropTable.addItemDrop(ItemId.UNIDENTIFIED_RUNE_POPPY.id(), 1, 2);
		herbDropTable.addItemDrop(ItemId.UNIDENTIFIED_DRAGON_LOTUS.id(), 1, 1);
	...
	private void createRareDropTable() {
		...
		rareDropTable.addItemDrop(ItemId.UNCUT_SAPPHIRE.id(), 1, 30);
		rareDropTable.addItemDrop(ItemId.UNCUT_EMERALD.id(), 1, 12);
		rareDropTable.addItemDrop(ItemId.UNCUT_RUBY.id(), 1, 10);
		rareDropTable.addItemDrop(ItemId.UNCUT_DIAMOND.id(), 1, 8);
		rareDropTable.addItemDrop(ItemId.UNCUT_OPAL.id(), 1, 4);
		rareDropTable.addItemDrop(ItemId.UNCUT_RED_TOPAZ.id(), 1, 4);
		rareDropTable.addItemDrop(ItemId.UNCUT_JADE.id(), 1, 4);
		rareDropTable.addItemDrop(ItemId.UNCUT_ONYX.id(), 1, 1);
	...
	private void createUltraRareDropTable() {
		...
		ultraRareDropTable.addItemDrop(ItemId.MEDIUM_DRAGON_HELMET.id(), 1, 1);
	...
	private void generateNpcDrops() {
		...
		currentNpcDrops.addItemDrop(ItemId.MEDIUM_DRAGON_HELMET.id(), 1, 1);
