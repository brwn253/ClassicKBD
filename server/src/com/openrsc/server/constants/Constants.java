...
public final class Constants {
	 ...
	 */
	public final int[][] SPELLS = {{1, 1}, {5, 2}, {9, 3}, {13, 4}, {17, 5}, {23, 5}, {29, 6}, {35, 6}, {41, 7}, {47, 7}, {53, 8}, {59, 8}, {62, 9}, {65, 9}, {70, 10}, {75, 10}, {131, 12}, {137, 13}, {143, 14}, {149, 15}};
	...
	public static final Map<Spells, Integer> spellMap = new HashMap<Spells, Integer>() {{
		...
		put(Spells.MAGIC_CHEF, 48);
		put(Spells.SUPERSMITH_ITEM, 49);
		put(Spells.ENCHANT_LVL6_AMULET, 50);
		put(Spells.SUPER_ALCHEMY, 51);
		put(Spells.BONES_TO_PIRAHNAS, 52);
		put(Spells.ENCHANT_LVL7_AMULET, 53);
		put(Spells.DARK_WIND_ANNILILATE, 54);
		put(Spells.ENCHANT_LVL8_AMULET, 55);
		put(Spells.DARK_WATER_ANNILILATE, 56);
		put(Spells.CHARGE_PRAYER, 57);
		put(Spells.DARK_EARTH_ANNILILATE, 58);
		put(Spells.ENCHANT_LVL9_AMULET, 59);
		put(Spells.DARK_FIRE_ANNILILATE, 60);
	}};
