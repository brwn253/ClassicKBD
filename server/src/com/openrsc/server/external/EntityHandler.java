	...
	private void customItemConditions() {
		if (getServer().getConfig().WANT_EQUIPMENT_TAB) {
			...
			int[] wieldableArrows = new int[] {
				...
				ItemId.KHORIUM_ARROWS.id(), ItemId.POISON_KHORIUM_ARROWS.id(),
				ItemId.PLATINUM_ARROWS.id(), ItemId.POISON_PLATINUM_ARROWS.id(),
				ItemId.TITANIUM_ARROWS.id(), ItemId.POISON_TITANIUM_ARROWS.id()				
			};
			...
			items.get(ItemId.DRAGON_PICKAXE.id()).setWieldable(true);
			items.get(ItemId.KHORIUM_PICKAXE.id()).setWieldable(true);
			items.get(ItemId.PLATINUM_PICKAXE.id()).setWieldable(true);
			items.get(ItemId.TITANIUM_PICKAXE.id()).setWieldable(true);
			...
			items.get(ItemId.DRAGON_PICKAXE.id()).setWearableId(16);
			items.get(ItemId.KHORIUM_PICKAXE.id()).setWearableId(16);
			items.get(ItemId.PLATINUM_PICKAXE.id()).setWearableId(16);
			items.get(ItemId.TITANIUM_PICKAXE.id()).setWearableId(16);
			...
			items.get(ItemId.DRAGON_PICKAXE.id()).setWieldPosition(4);
			items.get(ItemId.KHORIUM_PICKAXE.id()).setWieldPosition(4);
			items.get(ItemId.PLATINUM_PICKAXE.id()).setWieldPosition(4);
			items.get(ItemId.TITANIUM_PICKAXE.id()).setWieldPosition(4);
			...
			items.get(ItemId.DRAGON_PICKAXE.id()).setRequiredLevel(60);
			items.get(ItemId.KHORIUM_PICKAXE.id()).setRequiredLevel(100);
			items.get(ItemId.PLATINUM_PICKAXE.id()).setRequiredLevel(130);
			items.get(ItemId.TITANIUM_PICKAXE.id()).setRequiredLevel(150);
			...
			items.get(ItemId.DRAGON_PICKAXE.id()).setRequiredSkillIndex(0);
			items.get(ItemId.KHORIUM_PICKAXE.id()).setRequiredSkillIndex(0);
			items.get(ItemId.PLATINUM_PICKAXE.id()).setRequiredSkillIndex(0);
			items.get(ItemId.TITANIUM_PICKAXE.id()).setRequiredSkillIndex(0);
			...
			items.get(ItemId.DRAGON_PICKAXE.id()).setWeaponAimBonus(30);
			items.get(ItemId.KHORIUM_PICKAXE.id()).setWeaponAimBonus(38);
			items.get(ItemId.PLATINUM_PICKAXE.id()).setWeaponAimBonus(44);
			items.get(ItemId.TITANIUM_PICKAXE.id()).setWeaponAimBonus(50);
			...
			items.get(ItemId.DRAGON_PICKAXE.id()).setWeaponPowerBonus(30);
			items.get(ItemId.KHORIUM_PICKAXE.id()).setWeaponPowerBonus(38);
			items.get(ItemId.PLATINUM_PICKAXE.id()).setWeaponPowerBonus(44);
			items.get(ItemId.TITANIUM_PICKAXE.id()).setWeaponPowerBonus(50);
			...
			items.get(ItemId.DRAGON_PICKAXE.id()).setAppearanceId(564);
			items.get(ItemId.KHORIUM_PICKAXE.id()).setAppearanceId(540);
			items.get(ItemId.PLATINUM_PICKAXE.id()).setAppearanceId(541);
			items.get(ItemId.TITANIUM_PICKAXE.id()).setAppearanceId(542);
		...
		if (getServer().getConfig().WANT_CUSTOM_SPRITES) {
			...
			items.get(ItemId.DRAGON_WOODCUTTING_AXE.id()).setAppearanceId(303);
			items.get(ItemId.KHORIUM_AXE.id()).setAppearanceId(537);
			items.get(ItemId.PLATINUM_AXE.id()).setAppearanceId(538);
			items.get(ItemId.TITANIUM_AXE.id()).setAppearanceId(539);
			...
			items.get(ItemId.DRAGON_KITE_SHIELD.id()).setAppearanceId(449);
			items.get(ItemId.KHORIUM_KITE_SHIELD.id()).setAppearanceId(531);
			items.get(ItemId.PLATINUM_KITE_SHIELD.id()).setAppearanceId(532);
			items.get(ItemId.TITANIUM_KITE_SHIELD.id()).setAppearanceId(533);

			items.get(ItemId.DRAGON_SQUARE_SHIELD.id()).setAppearanceId(244);

			items.get(ItemId.MEDIUM_DRAGON_HELMET.id()).setAppearanceId(245);
			...
			items.get(ItemId.DRAGON_PLATED_SKIRT.id()).setAppearanceId(300);
			items.get(ItemId.KHORIUM_PLATED_SKIRT.id()).setAppearanceId(528);
			items.get(ItemId.PLATINUM_PLATED_SKIRT.id()).setAppearanceId(529);
			items.get(ItemId.TITANIUM_PLATED_SKIRT.id()).setAppearanceId(530);
			...
			items.get(ItemId.MYSTIC_LONGBOW.id()).setAppearanceId(575);
			items.get(ItemId.MYSTIC_SHORTBOW.id()).setAppearanceId(575);
			items.get(ItemId.CORK_LONGBOW.id()).setAppearanceId(576);
			items.get(ItemId.CORK_SHORTBOW.id()).setAppearanceId(576);
			items.get(ItemId.BOOJUM_LONGBOW.id()).setAppearanceId(577);
			items.get(ItemId.BOOJUM_SHORTBOW.id()).setAppearanceId(577);
			items.get(ItemId.GUM_LONGBOW.id()).setAppearanceId(578);
			items.get(ItemId.GUM_SHORTBOW.id()).setAppearanceId(578);
			items.get(ItemId.TWISTED_LONGBOW.id()).setAppearanceId(579);
			items.get(ItemId.TWISTED_SHORTBOW.id()).setAppearanceId(579);
			...
			items.get(ItemId.DRAGON_SHORT_SWORD.id()).setAppearanceId(566);
			items.get(ItemId.KHORIUM_SHORT_SWORD.id()).setAppearanceId(549);
			items.get(ItemId.PLATINUM_SHORT_SWORD.id()).setAppearanceId(550);
			items.get(ItemId.TITANIUM_SHORT_SWORD.id()).setAppearanceId(551);
			...
			items.get(ItemId.KHORIUM_DAGGER.id()).setAppearanceId(543);
			items.get(ItemId.PLATINUM_DAGGER.id()).setAppearanceId(544);
			items.get(ItemId.TITANIUM_DAGGER.id()).setAppearanceId(545);
			...
			items.get(ItemId.POISONED_KHORIUM_DAGGER.id()).setAppearanceId(546);
			items.get(ItemId.POISONED_PLATINUM_DAGGER.id()).setAppearanceId(547);
			items.get(ItemId.POISONED_TITANIUM_DAGGER.id()).setAppearanceId(548);
			...
			items.get(ItemId.DRAGON_2_HANDED_SWORD.id()).setAppearanceId(403);
			items.get(ItemId.KHORIUM_2_HANDED_SWORD.id()).setAppearanceId(555);
			items.get(ItemId.PLATINUM_2_HANDED_SWORD.id()).setAppearanceId(556);
			items.get(ItemId.TITANIUM_2_HANDED_SWORD.id()).setAppearanceId(557);
			...
			items.get(ItemId.DRAGON_SPEAR.id()).setAppearanceId(568);
			items.get(ItemId.KHORIUM_SPEAR.id()).setAppearanceId(588);
			items.get(ItemId.PLATINUM_SPEAR.id()).setAppearanceId(589);
			items.get(ItemId.TITANIUM_SPEAR.id()).setAppearanceId(590);
			...
			items.get(ItemId.POISONED_DRAGON_SPEAR.id()).setAppearanceId(570);
			items.get(ItemId.POISONED_KHORIUM_SPEAR.id()).setAppearanceId(571);
			items.get(ItemId.POISONED_PLATINUM_SPEAR.id()).setAppearanceId(572);
			items.get(ItemId.POISONED_TITANIUM_SPEAR.id()).setAppearanceId(573);
			...
			items.get(ItemId.OPAL_NECKLACE.id()).setAppearanceId(580);
			items.get(ItemId.OPAL_AMULET.id()).setAppearanceId(581);
			items.get(ItemId.TOPAZ_NECKLACE.id()).setAppearanceId(582);
			items.get(ItemId.TOPAZ_AMULET.id()).setAppearanceId(583);
			items.get(ItemId.JADE_NECKLACE.id()).setAppearanceId(584);
			items.get(ItemId.JADE_AMULET.id()).setAppearanceId(585);
			items.get(ItemId.ONYX_NECKLACE.id()).setAppearanceId(586);
			items.get(ItemId.ONYX_AMULET.id()).setAppearanceId(587);
			...
			items.get(ItemId.DRAGON_CHAIN_MAIL_LEGS.id()).setAppearanceId(569);
			items.get(ItemId.KHORIUM_CHAIN_MAIL_LEGS.id()).setAppearanceId(561);
			items.get(ItemId.PLATINUM_CHAIN_MAIL_LEGS.id()).setAppearanceId(562);
			items.get(ItemId.TITANIUM_CHAIN_MAIL_LEGS.id()).setAppearanceId(563);
			...
			items.get(ItemId.DRAGON_SCIMITAR.id()).setAppearanceId(567);
			items.get(ItemId.KHORIUM_SCIMITAR.id()).setAppearanceId(552);
			items.get(ItemId.PLATINUM_SCIMITAR.id()).setAppearanceId(553);
			items.get(ItemId.TITANIUM_SCIMITAR.id()).setAppearanceId(554);
