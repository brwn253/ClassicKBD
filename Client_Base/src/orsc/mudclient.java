...
//							}
	...
	void setExperienceArray() {
		...
		for (int i = 0; i < S_PLAYER_LEVEL_LIMIT; ++i) {
			...
			experience += experienceIncrease / 4;
			this.experienceArray[i] = (int)((experience & 0xffffffffL));
		}
		System.out.println("Level Limit: " + S_PLAYER_LEVEL_LIMIT);
		System.out.println("" + this.experienceArray[S_PLAYER_LEVEL_LIMIT-1]);
	}
	...
	private void setSkillGuideChosen(String skillGuideChosen) {
		...
		if (skillGuideChosen.equalsIgnoreCase("Attack")) {
			...
			skillGuideChosenTabs.add("Leather & Cloth");
			...
			skillGuideChosenTabs.add("Khorium");
			skillGuideChosenTabs.add("Platinum");
			skillGuideChosenTabs.add("Titanium");
